...
module.exports = function (app, client) {
  ...
  app.post("/send-message", verifyKey, async (req, res) => {
    console.log(req.data,req.body,req.headers)
    const message = JSON.parse(decodeURIComponent(req.body))["message"];
    const ids = JSON.parse(decodeURIComponent(req.body))["phone"];
